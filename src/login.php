<?php
  require_once('./share/dao/userdao.php');
  session_start();
...
<?php 
  ...
  function login() {
    ...
    $_SESSION['session_username'] = serialize($result);
    redirect("auth.php");
  }
?>
    ...
    <form class="col-4 offset-4 border p-3 pb-4 rounded d-grid gap-3" action="login.php" method="post">
      <fieldset class="d-grid gap-2">
        ...
        <section class="d-grid gap-4">
          <input name="username" placeholder="Nombre de usuario" type="text" class="form-control">
