...
require_once(__DIR__.'/../../share/model/audit_student.php');
require_once(__DIR__.'/../../share/dao/audit_studentdao.php');
...
$allUsers = (new AuditStudentDao())->getAll();
...
<body>
  ...
  <main class="main my-5 mx-5 py-5 px-5">
    <div class="row justify-content-center">
      <section class="text-center col-7 fs-2 py-2 border mx-5 fw-bolder"> Auditoria </section>
    </div>
    <table class="table table-dark mt-5 table-striped">
      <thead>
        <tr>
          ...
          <th scope="col">Anterior Programa</th>
          <th scope="col">Nuevo Programa</th>
          <th scope="col">ID del Admin</th>
      ...
      <tbody>
          <?php
            foreach ($allUsers as $u) {
              ...
              echo  "<td>{$u->previous_name}</td>";
              echo  "<td>{$u->new_name}</td>";
              echo  "<td>{$u->previous_program}</td>";
              echo  "<td>{$u->new_program}</td>";
              echo  "<td>{$u->userId}</td>";
              echo  "<td>{$u->modify}</td>";
              echo  "<td>{$u->process}</td>";
              echo  "<td>{$u->idStudent}</td></tr>";
            }
          ?>
      </tbody>
    </table>
